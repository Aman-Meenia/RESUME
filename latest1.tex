...
\begin{center}
    ...
    \href{https://linkedin.com/in/aman-meenia-b32a00206/}{\raisebox{-0.2\height}\faLinkedin\ \underline{linkedin.com/in/aman-meenia}} ~
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Migrated a client’s legacy AngularJS website to NextJS, resulting in faster load times and a 30\% boost in SEO ranking.}
        \resumeItem{Designed responsive, modern UI components using DaisyUI, enhancing user experience and contributing to a 20\% increase in user satisfaction.}
        \resumeItem{Optimized performance by implementing server-side rendering in NextJS, cutting page load times by up to 40\%, significantly improving user experience..}
    \resumeItemListEnd
