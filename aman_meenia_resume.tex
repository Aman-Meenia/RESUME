...
% \end{tabular*}
\begin{center}
    {\Huge \scshape Aman Meenia} \\ \vspace{1pt}
    ...
    \href{https://linkedin.com/in/aman-meenia-b32a00206/}{\raisebox{-0.2\height}\faLinkedin\ \underline{LinkedIn}} ~
    \href{https://github.com/Aman-Meenia}{\raisebox{-0.2\height}\faGithub\ \underline{GitHub}} ~
    \href{https://aman-com.vercel.app}{\raisebox{-0.2\height}\faGlobe\ \underline{Portfolio}}
    \vspace{-8pt}
\end{center}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed the company's web platform using React.js, ensuring a responsive, high-performance interface that provides an intuitive and seamless user experience.}
        \resumeItem{
        Collaborating with the team to build the mobile app using React Native, focusing on delivering a seamless mobile experience.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Migration Project: Successfully migrated a client website from AngularJS to Next.js, significantly improving performance and SEO rankings.}
        \resumeItem{UI Design: Leveraged the DaisyUI library for efficient, responsive, and modern UI component design, enhancing the user experience.}
        \resumeItem{Performance Optimization: Implemented server-side rendering with Next.js to optimize loading speeds and boost overall application performance.}
    \resumeItemListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Web Technologies}{: ReactJS, NextJS, ExpressJS, NodeJS, Redux, MongoDB, Prisma, Postgres} \\
...
\section{Achievements}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListEnd
          \vspace{-13pt}       \resumeProjectHeading
          {\textbf{LeetCode} 
    ...
    \resumeSubHeadingListEnd
\vspace{-15pt} % Final adjustment to reduce spacing below section
